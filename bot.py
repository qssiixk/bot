...
async def grammar(ctx):
    await ctx.send("Грамматические правила: Структура предложения. В предложении должно быть подлежащее и сказуемое.
Части речи. Слова подразделяются на существительные, глаголы, прилагательные, наречия, местоимения, предлоги, союзы и междометия.
Соглашение. Подлежащее и глагол должны совпадать по количеству.
Последовательность времени. Глаголы должны употребляться последовательно в одном и том же времени.")

# Грамматическое обучение
@bot.command(name='grammar')
async def grammar(ctx):
    await ctx.send("Грамматические правила: Модификаторы. Прилагательные и наречия должны быть правильно расставлены в предложениях.
Параллелизм. Идеи в списке или сравнении должны быть выражены в параллельной форме.
Заглавная буква. Первое слово предложения и имена собственные должны быть написаны с заглавной буквы.
Пунктуация. Правильное использование знаков препинания имеет решающее значение для чёткого и лаконичного письма.")
